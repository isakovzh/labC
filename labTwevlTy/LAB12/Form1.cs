...
namespace LAB12
{
    public partial class Form1 : Form
    {
        ...
        private void toolStripTextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            dataGridView1.Rows[1].DefaultCellStyle.BackColor = Color.White; // zeroing the color
            for (int i = 0; i < dataGridView1.RowCount; i++)
                    ...
                    Contains(toolStripTextBox1.Text.Trim().ToLower())) // Contains - comparison of texts from the grid cell and the entered value
                {
                    ...
                    dataGridView1.Rows[1].DefaultCellStyle.BackColor = Color.Aqua; // coloring the desired cell
                    return;
                }
